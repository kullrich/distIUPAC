#' @title biSites
#' @name biSites
#' @description This function returns bi-allelic site positions given a dna object \code{DNAStringSet}, also with IUPAC code.
#' @import Biostrings
#' @import ape
#' @import doMC
#' @import foreach
...
biSites<-function(dna,x.pos,wlen=25000,threads=1,pB=TRUE){
  options(scipen=22)
  dna_<-dna[x.pos]
