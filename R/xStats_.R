...
xStats_<-function(dna, x.pos=NULL, wlen=25000, wjump=25000, start.by=NULL, end.by=NULL, wtype="bp", dist="IUPAC", global.deletion=TRUE, threads=1, x.name="x", chr.name="chr", pB=TRUE){
  options(scipen=22)
